...
//        // 方法二：按高度和宽度缩放
        ImageUtils.scale2("d:/test/michael/michael/0350050103.jpg", "d:/test/michael/michael/0350050103.jpg", 500, 300, true);//测试OK
//        // 2-切割图像：
//        // 方法一：按指定起点坐标和宽高切割
...
//        ImageUtils.pressText2("我也是水印文字", "e:/abc.jpg","e:/abc_pressText2.jpg", "黑体", 36, Color.white, 80, 0, 0, 0.5f);//测试OK
        ...
        // 6-给图片添加图片水印：
        //ImageUtils.pressImage("d:/test/michael/michael/logo.png", "d:/test/michael/michael/0350050103.jpg","d:/test/michael/target/img_mark_icon.jpg", 0, 0, 1f,-45);//测试OK
    }
    /**
     * 缩放图像（按比例缩放）
